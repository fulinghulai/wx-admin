 ...
 * Date:     2019-08-02 20:08
 * Description:
 */
public class ShareDailyResultType {
	...
	public ShareDailyResultType() {
	}

	public ShareDailyResultType(String ds, int totalNum, int dauNum, int installNum, int payCount, int payAmount, int payTimes, int payInstallCount, int payInstallAmount, int payInstallTimes) {
		this.ds = ds;
